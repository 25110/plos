...
static cl::opt<bool> ShortenInstructions("shorten-instructions",
                                         ...
                                         cl::init(true),
                                         cl::cat(BoltOptCategory));
static cl::opt<bool> PrintPostLinkOutlining("post-link-outlining",
                       cl::desc(" post-link outlining pass"),
                       cl::init(false),
                       cl::cat(BoltOptCategory));
...
Error BinaryFunctionPassManager::runAllPasses(BinaryContext &BC) {
  ...
  Manager.registerPass(std::make_unique<PostLinkOutlining>(PrintPostLinkOutlining));
